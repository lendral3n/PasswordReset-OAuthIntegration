...
type GoogleInterface interface {
	...
	GetGoogleUser(access_token string, id_token string) (*user.Core, error)
}
...
func (google *GoogleOauth) GetGoogleUser(access_token string, id_token string) (*user.Core, error) {
